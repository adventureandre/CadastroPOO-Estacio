...
public class BuscarPessoa {
    ...
    public BuscarPessoa(
            Scanner sc, PessoaFisicaRepo pessoa, PessoaJuridicaRepo empresa) {
        this.sc = sc;
        this.pessoa = pessoa;
    ...
    public void buscarPessoa() {
        ...
        do { if (tipoPessoa.equals("f")) {
            ...
            if (getBuscaPessoa != null) {
                ...
                System.out.println("Nome: " + getBuscaPessoa.getNome()); System.out.println("CPF: " + getBuscaPessoa.getCpf());
                System.out.println("Idade: " + getBuscaPessoa.getIdade()); System.out.println("-------------------------------");
            } else {
            ...
            if (getBuscaPessoa != null) {
                System.out.println("Id: " + getBuscaPessoa.getId());
                System.out.println("Nome: " + getBuscaPessoa.getNome()); System.out.println("CNPJ: " + getBuscaPessoa.getCnpj()); System.out.println("-------------------------------"); } else { System.out.println("Empresa não encontrada!");
            }
            tipoPessoa = "null";
        }
        } while ((tipoPessoa.equals("f") || tipoPessoa.equals("j")));
